    ...
    <div class="container">
      ...
      <section class="customer-feedback" id="feedback-section">
        <div class="row">
          <div class="col-12 text-center pb-5">
            <h2>Bantuan</h2>
            <h6 class="section-subtitle text-muted m-0">Kontak Teknisi PLN Terdekat.</h6>
          </div>
          <div class="owl-carousel owl-theme grid-margin">
              <div class="card customer-cards">
                <div class="card-body">
                  <div class="text-center">
                    <img src="images/teknisi.jpg" width="150" height="150" alt="" class="img-customer">
                    <p class="m-0 py-3 text-muted">No HP : 081234xxxx / email : alisahnm@gmail.com</p>
                    <div class="content-divider m-auto"></div>
                    <h6 class="card-title pt-3">Alisa Hanum</h6>
                    <h6 class="customer-designation text-muted m-0">Teknisi Lapangan</h6>
                  </div>
                </div>
              </div>
              <div class="card customer-cards">
                <div class="card-body">
                  <div class="text-center">
                    <img src="images/teknisi 2.jpg" width="150" height="150" alt="" class="img-customer">
                    <p class="m-0 py-3 text-muted">No HP : 082453xxxx / email : jksusilo01@gmail.com</p>
                    <div class="content-divider m-auto"></div>
                    <h6 class="card-title pt-3">Joko Susilo</h6>
                    <h6 class="customer-designation text-muted m-0">Teknisi Lapangan</h6>
                  </div>
                </div>
              </div>
              <div class="card customer-cards">
                <div class="card-body">
                  <div class="text-center">
                    <img src="images/teknisi 3.jpg" width="150" height="150" alt="" class="img-customer">
                    <p class="m-0 py-3 text-muted">No HP : 082433xxxx / email : sambohoki@gmail.com</p>
                    <div class="content-divider m-auto"></div>
                    <h6 class="card-title pt-3">Fersy Sambo</h6>
                    <h6 class="customer-designation text-muted m-0">Teknisi Lapangan</h6>
                  </div>
                </div>
              </div>
